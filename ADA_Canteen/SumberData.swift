...
final class DataHelper {
    ...
    let allTenants: [TenantItem] = [
        ...
        TenantItem(id: 12,
                   ...
                   minPrice: 15000,
                   maxPrice: 33000,
                   tags: ["kategori.Ayam", "kategori.Sapi", "kategori.Cabe", "kategori.Sayur", "kategori.Ikan"],
        ...
        TenantItem(id: 13,
                   ...
                   minPrice: 13000,
                   maxPrice: 25000,
                   tags: ["kategori.Ikan", "kategori.Sapi", "kategori.Sayur", "kategori.Cabe"],
    ...
    // Helper untuk mendapatkan semua food items
    var allFoodItems: [FoodItem] {
        allTenants.flatMap { $0.foodItems }
    }
    
    // Filter by kategori
    func filterFoodItems(byTag tag: String) -> [FoodItem] {
        allFoodItems.filter { $0.tags.contains(tag) }
    }
}
